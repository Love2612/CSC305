...
//intrinsics::abort();
loop{hlt();}// the loop is here so that it can keep running forever
}
...
pub extern "C" fn _start() -> ! {
 ...
 write_position(framebuffer, 1, 3, "Hello!", Colour::LightRed, Colour::Blue);

    write_position(framebuffer, 20, 3, "I'm tired", Colour::LightGreen, Colour::Blue);
